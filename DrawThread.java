...
public class DrawThread implements Runnable{
	...
	public void start(final Stage primaryStage) {
		...
		scene.addEventFilter(MouseEvent.MOUSE_PRESSED, new EventHandler<MouseEvent>() {
			...
			// 		int ballID = getBall(mouseEvent.getSceneX(),mouseEvent.getSceneY());
	...
	//this method is responsible for drawing and handing collisions. 
	public void run(){
		//check for add onto list
